...
//  of both hand emojis side-by-side with names.
// ─────────────────────────────────────────────────────────────
...
class _RPSRevealScreenState extends State<RPSRevealScreen>
  ...
  void initState() {
    ...
    _popA = CurvedAnimation(parent: _popCtrl,
        curve: const Interval(0.0, 1.0, curve: Curves.elasticOut));
    _popB = CurvedAnimation(parent: _popCtrl,
            ...
            children: [
              ...
              AnimatedBuilder(
                ...
                builder: (_, __) => SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    ...
                    valueColor: const AlwaysStoppedAnimation(RPSTheme.purple),
                  ),
                ),
              ),
              // Ball
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: RPSTheme.purple.withOpacity(0.44),
                        blurRadius: 55),
                  ],
                ),
                child: Center(
