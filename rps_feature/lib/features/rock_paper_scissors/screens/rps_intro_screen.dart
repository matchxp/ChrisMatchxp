...
//  Layout: ROCK / PAPER / SCISSORS title (gold-white-gold),
//  three floating hand emojis that shuffle every 3 s,
//  View tutorial (purple underlined), Play now pill button.
// ─────────────────────────────────────────────────────────────
...
class _RPSIntroScreenState extends State<RPSIntroScreen>
  ...
  void initState() {
    super.initState();
    _floatCtrls = List.generate(3, (i) => AnimationController(
      vsync: this,
      duration: Duration(milliseconds: 2800 + i * 400),
    )..repeat(reverse: true));
    _floats = List.generate(3, (i) =>
      Tween<double>(begin: 0, end: -13).animate(
                          ...
                          return Padding(
                            ...
                            child: AnimatedBuilder(
                              ...
                              builder: (_, child) => Transform.translate(
                                // Round to whole pixels — sub-pixel offsets
                                // cause bitmap emojis to blur on Android.
                                offset: Offset(0, _floats[i].value.roundToDouble()),
                                child: child,
                              ),
