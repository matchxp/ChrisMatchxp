...
class _BiometricsScreenState extends State<BiometricsScreen>
  ...
  Future<void> _simulateScan(String type) async {
    ...
    _snack('${type == 'face' ? 'Face ID' : 'Fingerprint'} enabled!',
        color: _purple);
  }
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  Text(
                    _isScanning ? 'Scanning…' : 'Biometric Login',
                  ...
                  _biometricCard(
                    ...
                    onToggle: (v) {
                      if (v) {
                        _simulateScan('finger');
                      } else {
                        setState(() => _fingerprintEnabled = false);
                        _snack('Fingerprint disabled');
                      }
                    },
                  ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon,
                  color: enabled ? _purple : Colors.white38, size: 22),
            ),
